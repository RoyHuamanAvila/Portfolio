		...
		<div id="about" className="pb-3 about section">
			<div className="about-container pt-2">
				<div className="about__info-container">
					...
					<a href='https://royandresdev-portfolio.s3.sa-east-1.amazonaws.com/C.V.+ROY+HUAMAN+AVILA.pdf' download='CV-RoyHuaman' target='_blank' className='mt-2 btn btn-accent text-white' rel="noreferrer">Ver Curriculum</a>
				</div>
